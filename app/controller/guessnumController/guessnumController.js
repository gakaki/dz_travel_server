...
class GuessnumController extends Controller {
    async sendpack(ctx) {
        ...
        if (orderId) {
            let pack = await ctx.model.guessnumModel.PackInfo.findOne({"orderId": orderId});
            if (pack != null) {
                pack.userInfo = ui;
            ...
            let resultP = await this.service.guessnumService.guessnumService.sendPack(ui, money, title, useTicket);
    ...
    async guesspack(ctx) {
        ...
        let pack = await ctx.model.guessnumModel.PackInfo.findOne({pid: pid});
        if (pack == null) {
            result.code = constant.Code.PACK_EMPTY;
            ctx.body = result;
            return
        ...
        ctx.body = await this.service.guessnumService.guessnumService.guessPack(ui, pack, guessNum, _sid);
    }
    ...
    async clearcd(ctx) {
        ...
        ctx.body = await this.service.guessnumService.guessnumService.clearCD(ui, pack, _sid);
    }
    ...
    async getpackrecords(ctx) {
        ...
        ctx.body = await this.service.guessnumService.guessnumService.getPackRecords(ui, pack);
    }
    ...
    async getpackrankinglist(ctx) {
        ...
        ctx.body = await this.service.guessnumService.guessnumService.getPackRankingList(ui, pack);
    }
    ...
    async getuserpackrecords(ctx) {
        ...
        ctx.body = await this.service.guessnumService.guessnumService.getUserPackRecords(ui, Number(sendPageN), Number(sendLimitN), Number(receivePageN), Number(receiveLimitN));
    }
    ...
    async getacceleration(ctx) {
        ...
        ctx.body = await this.service.guessnumService.guessnumService.getAcceleration(ui);
    }
}
