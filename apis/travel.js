...
class Tourpal extends Base {
    constructor() {
        super();
        this.action = 'player.tourpal';
    ...
    set companions(v) {this._companions = v}
    static Init(ctx, checkLogin = false) {
        let o = new Tourpal();
        o.ctx = ctx;
        o.code = 0;
